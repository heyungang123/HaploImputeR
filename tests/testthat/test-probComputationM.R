test_that("probComputationM validates input", {
  hap_Y <- matrix(sample(0:1, 200, replace = TRUE), nrow = 2)
  hap_X_ref <- matrix(sample(0:1, 1000, replace = TRUE), nrow = 50)
  hap_X_prior <- matrix(sample(0:1, 200, replace = TRUE), nrow = 50)
...
test_that("probComputationM validates dimension matching", {
  hap_Y <- matrix(sample(0:1, 200, replace = TRUE), nrow = 2)
  hap_X_ref <- matrix(sample(0:1, 1000, replace = TRUE), nrow = 50)
  hap_X_prior <- matrix(sample(0:1, 200, replace = TRUE), nrow = 30) # Wrong dimension
